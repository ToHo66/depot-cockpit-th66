...
(() => {
  ...
  function normalizeSpaceX() {
    ...
    if(changed){
      writeBackup(raw,'pre-5.10.1-spacex-normalize');
  ...
  window.__DC_PRELOAD_5101__={version:VERSION,store:STORE,backup:BACKUP,history:HISTORY,spaceX:spaceXResult};
  console.info('Depot-Cockpit 5.10.1 clean preload active', window.__DC_PRELOAD_5101__);
})();
